...
#                                                 +#+#+#+#+#+   +#+            #
#    Created: 2016/05/15 09:04:04 by zmoola            #+#    #+#              #
#    Updated: 2016/11/14 12:43:03 by zmoola           ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRC = ft_memset.c ft_bzero.c ft_memcpy.c ft_memccpy.c ft_memmove.c\
	   ...
	   ft_strjoin.c ft_itoa.c ft_putchar.c ft_putstr.c ft_putendl.c\
	   ft_putnbr.c ft_putchar_fd.c ft_putstr_fd.c ft_putendl_fd.c\
	   ft_putnbr_fd.c ft_strtrim.c ft_strnequ.c ft_strsplit.c\
